...
| `duration`         | `duration`          | Set a duration for this view. When this value exists, the page will automatically progress when the duration in seconds has passed.                                                                                  | `number`                                                               | `undefined`          |
